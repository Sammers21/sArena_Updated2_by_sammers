...
local layout = {}
layout.name = "|cff00b4ffBlizz|r Compact"
...
function layout:Initialize(frame)
    ...
    frame.ClassIcon.Mask:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    frame.ClassIcon.Mask:SetAllPoints(classIcon.Texture)
    classIcon.Texture:AddMaskTexture(frame.ClassIcon.Mask)
    frame.ClassIcon.Cooldown:SetSwipeTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout")
    ...
    trinket.Mask:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    trinket.Mask:SetAllPoints(trinket.Texture)
    trinket.Texture:AddMaskTexture(trinket.Mask)
    trinket.Cooldown:SetSwipeTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout")
    ...
    racial.Mask:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    ...
    racial.Cooldown:SetSwipeTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout")
    ...
    dispel.Mask:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    dispel.Mask:SetAllPoints(dispel.Texture)

    -- Apply the mask
    dispel.Texture:AddMaskTexture(dispel.Mask)

    dispel.Cooldown:SetSwipeTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\talentsmasknodechoiceflyout")
    ...
    specBorder:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\Map_Faction_Ring.tga")
    ...
    frameTexture:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-HUD-UnitFrame-Player-PortraitOff-Large.tga")
