...
function layout:Initialize(frame)
    ...
    if self.db.hideNameBackground then
        frameTexture:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn-NoShadow.tga")
    else
        frameTexture:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn.tga")
    end
