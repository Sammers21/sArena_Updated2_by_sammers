...
function layout:Initialize(frame)
    ...
    frame.AuraStacks:SetFont("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\arialn.ttf", 18, "THICKOUTLINE")
    ...
    if self.db.bigHealthbar then
        ...
        frameTexture:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-TargetingFrame-NoLevel-Large")
    else
