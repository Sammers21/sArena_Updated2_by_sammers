-- Korean localization for sArena Updated 2 by sammers
-- sArena Updated 2 by sammers 한국어 현지화
...
L["Option_ImportDescription"] = "다른 sArena 설정을 새로운 sArena |cffff8000Reloaded|r  버전으로 가져옵니다.\n\n두 애드온이 모두 활성화되어 있는지 확인한 후 아래 버튼을 클릭하세요."
...
L["Conflict_UseOther_Desc"] = "이것은 |cffffffffsArena |cffff8000Reloaded|r 를 비활성화하고 대신 다른 sArena를 사용하고 UI를 다시 로드합니다."
L["Conflict_UseOther_Confirm"] = "이것은 |cffffffffsArena |cffff8000Reloaded|r 를 비활성화하고 대신 다른 sArena를 사용하고 UI를 다시 로드합니다.\n\n계속하시겠습니까?"
L["Conflict_UseReloaded_Import"] = "|cffffffffsArena |cffff8000Reloaded|r  사용: 다른 설정 가져오기"
L["Conflict_UseReloaded_Import_Desc"] = "이것은 다른 sArena에서 현재 프로필과 기존 설정을 복사하고 호환성을 위해 다른 sArena를 비활성화하고 UI를 다시 로드하여 sArena |cffff8000Reloaded|r  사용을 시작할 수 있게 합니다"
L["Conflict_UseReloaded_Import_Confirm"] = "이것은 다른 sArena에서 현재 프로필과 기존 설정을 복사하고 호환성을 위해 다른 sArena를 비활성화하고 UI를 다시 로드하여 sArena |cffff8000Reloaded|r  사용을 시작할 수 있게 합니다\n\n계속하시겠습니까?"
L["Conflict_UseReloaded_NoImport"] = "|cffffffffsArena |cffff8000Reloaded|r  사용: 다른 설정 가져오지 않기"
L["Conflict_UseReloaded_NoImport_Desc"] = "이것은 호환성을 위해 다른 sArena를 비활성화하고 UI를 다시 로드하여 다른 설정 없이 sArena |cffff8000Reloaded|r  사용을 시작할 수 있게 합니다."
L["Conflict_UseReloaded_NoImport_Confirm"] = "이것은 호환성을 위해 다른 sArena를 비활성화하고 UI를 다시 로드하여 다른 설정 없이 sArena |cffff8000Reloaded|r  사용을 시작할 수 있게 합니다.\n\n계속하시겠습니까?"
L["Midnight_UpdateInfo"] = "|cff00ff00업데이트: 이제 한밤에서 사용 가능합니다.|r\n\n한밤용 |cffffffffsArena |cffff8000Reloaded|r  개발을 계속할 계획입니다.\n\n일부 기능은 조정되거나 제거될 수 있지만 애드온은 계속 유지될 것입니다.\n한밤은 아직 초기 알파 단계이며 준비를 시작하지 않았지만 (10월 14일), 곧 시작할 것입니다.\n\n계획은 변경될 수 있지만 |cffffffffsArena |cffff8000Reloaded|r 와 제 다른 애드온들\n|A:gmchat-icon-blizz:16:16|aBetter|cff00c0ffBlizz|rFrames & |A:gmchat-icon-blizz:16:16|aBetter|cff00c0ffBlizz|rPlates가 한밤에서도 계속 유지될 것이라고 확신합니다 (변경/제거 포함).\n\n앞으로 많은 작업이 있으며, 모든 지원에 감사드립니다. (|cff00c0ff@bodify|r)\n몇 주/개월 후 더 자세한 정보를 알게 되면 이 섹션을 업데이트하겠습니다."
