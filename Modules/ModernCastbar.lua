...
if isRetail then
    ...
    local MOD_NONINT_TEX  = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Uninterruptable"
    local MOD_CHANNEL_TEX = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Filling-Channel"
    local MOD_CAST_TEX    = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Filling-Standard"
    local MOD_BG_TEX      = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Background.tga"
    local MOD_FRAME_TEX   = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Frame.tga"
    local MOD_TEXTBOX_TEX = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-TextBox.tga"
    local MOD_SHIELD_TEX  = "Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\UI-CastingBar-Shield.tga"
    ...
    local function ApplyModern(bar, simpleCastbar, frame, unit)
        ...
        bar.MaskTexture:SetTexture("Interface\\AddOns\\sArena_Updated2_by_sammers\\Textures\\RetailCastMask.tga",
            "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
